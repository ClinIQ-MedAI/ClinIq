abstract class LocaleKeys {
  ...
  static const aiScanRejectedTitle = "ai.scan.rejected_title";
  static const aiScanRejectedReason = "ai.scan.rejected_reason";
  static const aiScanRejectedSuggestions = "ai.scan.rejected_suggestions";
  static const aiScanRejectedUploadAnother = "ai.scan.rejected_upload_another";
  static const aiScanRejectedUrgency = "ai.scan.rejected_urgency";
  static const aiScanRejectedDetectionReason = "ai.scan.rejected_detection_reason";
  static const aiScanAnalysisComplete = "ai.scan.analysis_complete";
  static const aiScanAnalyzedSuccessfully = "ai.scan.analyzed_successfully";
  static const aiScanViewFullReport = "ai.scan.view_full_report";
  static const aiScanTapToReview = "ai.scan.tap_to_review";
  static const aiScanResultOriginalScan = "ai.scan.result.original_scan";
  static const aiScanResultUploadedImage = "ai.scan.result.uploaded_image";
  static const aiScanResultAiAnnotation = "ai.scan.result.ai_annotation";
  static const aiScanResultDetectedRegions = "ai.scan.result.detected_regions";
  static const aiScanResultAnnotated = "ai.scan.result.annotated";
  static const aiScanResultDiagnosis = "ai.scan.result.diagnosis";
  static const aiScanResultConfidence = "ai.scan.result.confidence";
  static const aiScanResultSummary = "ai.scan.result.summary";
  static const aiScanResultPatientContext = "ai.scan.result.patient_context";
  static const aiScanResultBodyPart = "ai.scan.result.body_part";
  static const aiScanResultClinicalMeaning = "ai.scan.result.clinical_meaning";
  static const aiScanResultClinicalInfo = "ai.scan.result.clinical_info";
  static const aiScanResultMetrics = "ai.scan.result.metrics";
  static const aiScanResultSeverity = "ai.scan.result.severity";
  static const aiScanResultProbabilities = "ai.scan.result.probabilities";
  static const aiScanResultRecommendations = "ai.scan.result.recommendations";
  static const aiScanResultInputValidation = "ai.scan.result.input_validation";
  static const aiScanResultPassed = "ai.scan.result.passed";
  static const aiScanResultFailed = "ai.scan.result.failed";
  static const aiScanResultValidationPassed = "ai.scan.result.validation_passed";
  static const aiScanResultValidationFailed = "ai.scan.result.validation_failed";
  static const aiScanResultAction = "ai.scan.result.action";
  static const aiScanResultWidth = "ai.scan.result.width";
  static const aiScanResultHeight = "ai.scan.result.height";
  static const aiScanResultAspectRatio = "ai.scan.result.aspect_ratio";
  static const aiScanResultIntensityStd = "ai.scan.result.intensity_std";
  static const aiScanResultColorSpread = "ai.scan.result.color_spread";
  static const aiScanResultColorfulFraction = "ai.scan.result.colorful_fraction";
  static const aiScanResultAnalysisId = "ai.scan.result.analysis_id";
